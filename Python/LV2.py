...
background_foreground = pygame.image.load('/Users/i589040/Documents/GitHub/Spiel-Info-Q11-2022/Bilder/Level 2/Level2_Overlay.png').convert_alpha()
background_foreground_2 = pygame.image.load('/Users/i589040/Documents/GitHub/Spiel-Info-Q11-2022/Bilder/Level 2/Level2_NotOverlay.png').convert_alpha()
...
obstacle_map = ObstacleMap("/Users/i589040/Documents/GitHub/Spiel-Info-Q11-2022/Bilder/Level 2/Level2_Collisions.png")
...
class World:
    ...
    def draw(self, surface):
        ...
        surface.blit(self.background_foreground_2, self.background_foreground_rect)
...
class Player:
    def __init__(self):
        ...
        self.gravity = 0.3
        self.jump_height = 14
        self.animation_frames = self.load_gif("/Users/i589040/Documents/GitHub/Spiel-Info-Q11-2022/Bilder/Objekte/Test 2 Animation running 1.gif",0.15)
    ...
    def update(self):
       ...
       # Inside Player.update() method before applying gravity
        ...
        if obstacle_map.collides_vertically_top(test_rect):
            self.dy = 0
