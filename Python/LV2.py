...
background_foreground_1 = pygame.transform.scale(background_foreground_1, (screen_size[1]*ASPECT_RATIO, screen_size[1]))
background_foreground_2 = pygame.transform.scale(background_foreground_2, (screen_size[1]*ASPECT_RATIO, screen_size[1]))
